...
export function LiveStatsPanel({ stats }) {
  ...
  return (
    <div className="bg-surface rounded-lg border border-border shadow-sm w-full max-w-3xl mb-6 p-6">
      ...
      <div className="mt-6 mb-8 flex justify-between items-center text-center">
        <div className="flex-1">
          ...
          <div className="text-2xl font-bold">{total_sent}</div>
        </div>
        <div className="text-text-muted">→</div>
        <div className="flex-1">
          <div className="text-xs uppercase text-info font-bold mb-2">Delivered</div>
          <div className="text-2xl font-bold text-info">{total_delivered}</div>
        </div>
        <div className="text-text-muted">→</div>
        <div className="flex-1">
          <div className="text-xs uppercase text-amber font-bold mb-2">Opened</div>
          <div className="text-2xl font-bold text-amber">{total_opened}</div>
        </div>
        <div className="text-text-muted">→</div>
        <div className="flex-1">
          <div className="text-xs uppercase text-primary font-bold mb-2">Clicked</div>
          <div className="text-2xl font-bold text-primary">{total_clicked}</div>
        </div>
        <div className="text-text-muted">→</div>
        <div className="flex-1">
          <div className="text-xs uppercase text-primary font-bold mb-2">Converted</div>
          <div className="text-2xl font-bold text-primary">{total_converted}</div>
        </div>
      </div>
